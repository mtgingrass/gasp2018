...
Government Advances in Statistical Programming (GASP!) Workshop is a workshop focused on statistical programming for government applications held at the Bureau of Labor Statistics in Washington DC on October 24 to 25, 2018.
...
I was surprised to hear that FDA employees can use **VMWare Player**. VMWare Player allows a user to run a second, isolated operating system on a single PC. This software will create a virtual environment within Windows that allows the user to install any software without restrictions.

 

 

I asked the presenter how he can access data from his Virtual Machine and he said he connects the VM to a shared folder. I am concerned about information security using this method; however, it's something to work with IT professional if required.
